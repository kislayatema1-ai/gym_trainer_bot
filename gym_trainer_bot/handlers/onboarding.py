...
async def send_pdf_file(callback: CallbackQuery):
    try:
        # Отправляем PDF файл (замените на путь к вашему файлу)
        pdf_file = FSInputFile("/Users/user/Desktop/gym_trainer_bot/Меню на сушке .pdf", filename="Рацион на день.pdf")
